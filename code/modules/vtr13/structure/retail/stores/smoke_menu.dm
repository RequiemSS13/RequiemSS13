/obj/structure/retail/smoke_menu
	products_list = list(new /datum/data/retail_product("malboro",	/obj/item/storage/fancy/cigarettes/cigpack_robust,	50),
		...
		new /datum/data/retail_product("cigars",	/obj/item/storage/fancy/cigarettes/cigars,	150),
